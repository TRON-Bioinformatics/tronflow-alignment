...
test-conda-aln-paired:
	nextflow main.nf -profile test,conda --cpus 1

test-conda-aln-single:
	nextflow main.nf -profile test,conda --library single  --cpus 1

test-conda-mem-paired:
	nextflow main.nf -profile test,conda --algorithm mem  --cpus 1

test-conda-mem-single:
	nextflow main.nf -profile test,conda --algorithm mem --library single  --cpus 1
